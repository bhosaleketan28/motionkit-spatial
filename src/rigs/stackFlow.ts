...
export const stackFlowRig: StackFlowRigDefinition = {
  ...
  family: "stack",
  gallery: { description: "A tactile layered deck advancing through a clear front position." },
  ...
  inspectorControls: [
    ...
    { fineStep: 0.1, key: "cardWidth", kind: "number", label: "Card width", largeStep: 5, max: 52, min: 30, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "cardHeight", kind: "number", label: "Card height", largeStep: 5, max: 76, min: 48, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "stackOffset", kind: "number", label: "Stack offset", largeStep: 2, max: 8, min: 1.5, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 0.5, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "stackDepth", kind: "number", label: "Stack depth", largeStep: 10, max: 100, min: 20, precision: 1, scale: 100, section: "appearance", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "backScale", kind: "number", label: "Back scale", largeStep: 5, max: 95, min: 55, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "backOpacity", kind: "number", label: "Back opacity", largeStep: 10, max: 90, min: 15, precision: 1, scale: 100, section: "appearance", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "rotationStep", kind: "number", label: "Rotation step", largeStep: 3, max: 8, min: -8, precision: 1, section: "appearance", sliderStep: 0.5, step: 0.5, unit: "°", unitLabel: "degrees" },
  ...
  inspectorSections: [
    { defaultOpen: true, id: "motion", label: "Stack sequence" },
    { defaultOpen: true, id: "appearance", label: "Layer geometry" },
  ...
  preview: { accent: "#77d2b4", durationSeconds: 8, generateMedia: generateStackFlowDemoMedia, mediaCount: 6, ratio: "1:1", render: renderStackFlow, settingsOverride: { frameRatio: "1:1" }, staticProgress: 0.43 },
