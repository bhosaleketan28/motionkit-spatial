...
export const focusDeckRig: FocusDeckRigDefinition = {
  ...
  inspectorControls: [
    ...
    { fineStep: 0.1, key: "heroEmphasis", kind: "number", label: "Hero emphasis", largeStep: 5, max: 18, min: 0, precision: 1, scale: 100, section: "depth", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    ...
    { fineStep: 0.1, key: "heroWidth", kind: "number", label: "Hero width", largeStep: 5, max: 52, min: 34, precision: 1, scale: 100, section: "layout", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "heroHeight", kind: "number", label: "Hero height", largeStep: 5, max: 76, min: 50, precision: 1, scale: 100, section: "layout", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "supportScale", kind: "number", label: "Support scale", largeStep: 5, max: 62, min: 34, precision: 1, scale: 100, section: "layout", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "supportSpread", kind: "number", label: "Support spread", largeStep: 5, max: 52, min: 25, precision: 1, scale: 100, section: "layout", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "deckDepth", kind: "number", label: "Deck depth", largeStep: 10, max: 80, min: 0, precision: 1, scale: 100, section: "depth", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "sideRotation", kind: "number", label: "Side rotation", largeStep: 5, max: 14, min: 0, precision: 1, section: "depth", sliderStep: 0.5, step: 1, unit: "°", unitLabel: "degrees" },
  ...
  inspectorSections: [
    ...
    { defaultOpen: true, id: "layout", label: "Deck layout" },
