...
export const gridWallRig: GridWallRigDefinition = {
  ...
  family: "grid",
  gallery: { description: "An architectural media grid with drifting focus rhythm." },
  ...
  inspectorControls: [
    ...
    { fineStep: 0.1, key: "focusScale", kind: "number", label: "Focus scale", largeStep: 5, max: 24, min: 0, precision: 1, scale: 100, section: "motion", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "focusDepth", kind: "number", label: "Focus depth", largeStep: 10, max: 80, min: 0, precision: 1, scale: 100, section: "motion", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "tileWidth", kind: "number", label: "Tile width", largeStep: 5, max: 31, min: 20, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "tileHeight", kind: "number", label: "Tile height", largeStep: 5, max: 40, min: 25, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "horizontalGap", kind: "number", label: "Horizontal gap", largeStep: 2, max: 6, min: 1, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 0.5, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "verticalGap", kind: "number", label: "Vertical gap", largeStep: 2, max: 8, min: 1, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 0.5, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "gridScale", kind: "number", label: "Grid scale", largeStep: 5, max: 100, min: 76, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "edgeOpacity", kind: "number", label: "Edge opacity", largeStep: 10, max: 100, min: 20, precision: 1, scale: 100, section: "appearance", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
  ...
  inspectorSections: [
    { defaultOpen: true, id: "motion", label: "Grid rhythm" },
    { defaultOpen: true, id: "appearance", label: "Tile geometry" },
  ...
  preview: { accent: "#78d6b8", durationSeconds: 9, generateMedia: generateGridWallDemoMedia, mediaCount: 6, ratio: "16:9", render: renderGridWall, settingsOverride: { frameRatio: "16:9" }, staticProgress: 0.28 },
