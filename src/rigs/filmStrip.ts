...
export const filmStripRig: FilmStripRigDefinition = {
  ...
  inspectorControls: [
    ...
    { fineStep: 0.1, key: "cardWidth", kind: "number", label: "Card width", largeStep: 5, max: 55, min: 20, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "cardHeight", kind: "number", label: "Card height", largeStep: 5, max: 78, min: 35, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "gap", kind: "number", label: "Gap", largeStep: 5, max: 12, min: 0, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "perspective", kind: "number", label: "Perspective", largeStep: 10, max: 80, min: 0, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "centerScale", kind: "number", label: "Center scale", largeStep: 5, max: 28, min: 0, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "edgeOpacity", kind: "number", label: "Edge opacity", largeStep: 10, max: 100, min: 15, precision: 1, scale: 100, section: "appearance", sliderStep: 0.1, step: 1, unit: "%", unitLabel: "percent" },
  ...
  inspectorSections: [
    ...
    { defaultOpen: true, id: "appearance", label: "Strip geometry" },
