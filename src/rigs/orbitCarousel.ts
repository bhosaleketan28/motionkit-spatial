...
export const orbitCarouselRig: OrbitCarouselRigDefinition = {
  ...
  family: "orbit",
  gallery: {
    description: "Cards circle a center point with depth—ideal for spatial showcases.",
    featured: true,
  },
  ...
  inspectorSections: [
    ...
    { defaultOpen: true, id: "layout", label: "Layout" },
  ...
  inspectorControls: [
    ...
    { fineStep: 0.1, key: "spread", kind: "number", label: "Spread", largeStep: 10, max: 100, min: 38, precision: 1, scale: 100, section: "layout", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "depthFade", kind: "number", label: "Depth fade", largeStep: 10, max: 85, min: 5, precision: 1, scale: 100, section: "depth", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    ...
    { fineStep: 0.1, key: "cardSize", kind: "number", label: "Card size", largeStep: 5, max: 44, min: 22, precision: 1, scale: 100, section: "layout", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
  ...
  preview: {
    ...
    settingsOverride: { cardSize: 0.4, depthFade: 0.58, frameRatio: "16:9", spread: 0.84 },
    staticProgress: 0.12,
  },
  render: renderOrbitCarousel,
