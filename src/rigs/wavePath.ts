...
export const wavePathRig: WavePathRigDefinition = {
  ...
  family: "path",
  gallery: { description: "A fluid open wave carrying media through expressive spatial motion." },
  ...
  inspectorControls: [
    ...
    { fineStep: 0.1, key: "cardWidth", kind: "number", label: "Card width", largeStep: 5, max: 42, min: 22, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "cardHeight", kind: "number", label: "Card height", largeStep: 5, max: 72, min: 42, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "gap", kind: "number", label: "Gap", largeStep: 5, max: 12, min: 0, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "perspective", kind: "number", label: "Perspective", largeStep: 10, max: 80, min: 0, precision: 1, scale: 100, section: "appearance", sliderStep: 1, step: 1, unit: "%", unitLabel: "percent" },
    { fineStep: 0.1, key: "centerScale", kind: "number", label: "Center scale", largeStep: 5, max: 28, min: 0, precision: 1, scale: 100, section: "appearance", sliderStep: 0.5, step: 1, unit: "%", unitLabel: "percent" },
  ...
  inspectorSections: [
    { defaultOpen: true, id: "motion", label: "Path motion" },
    { defaultOpen: true, id: "appearance", label: "Card geometry" },
  ...
  preview: { accent: "#70d2bc", durationSeconds: 10, generateMedia: generateWavePathDemoMedia, mediaCount: 6, ratio: "16:9", render: renderWavePath, settingsOverride: { frameRatio: "16:9" }, staticProgress: 0.21 },
